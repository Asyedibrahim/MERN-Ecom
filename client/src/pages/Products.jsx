        ...
        <div key={categoryData.category._id} className='flex flex-col gap-8 mt-10'>
          ...
          <div className='flex flex-wrap gap-5'>
            ...
            {categoryData.products.slice(0, 4).map((product) => (
              ...
              <div key={product._id} className='bg-white shadow-md hover:shadow-lg transition-shadow overflow-hidden rounded-lg w-full sm:w-[260px]' onClick={() => handleProductPage(product._id)}>
                <img src={product.imageUrls[0]} alt="" className='h-[300px] w-full object-cover hover:scale-105 transition-scale duration-300'/>
                <div className='p-3 flex flex-col gap-2 w-full mt-3'>
                  <h3 className='text-lg font-semibold text-slate-700 truncate'>{product.name}</h3>
