...
export default function EditProduct() {
    ...
    useEffect(() => {
        ...
        if (tabFromUrl.startsWith('editProduct/')) {
            const productId = tabFromUrl.split('/')[1];
            ...
            <div className="my-8">
                <div className="flex flex-col gap-2">
                    ...
                    <div className="flex gap-5 items-center">
                        ...
                        <Select onChange={(e) => setFormData({...formData, categoryId: e.target.value})} defaultValue={formData.categoryId.name}>
